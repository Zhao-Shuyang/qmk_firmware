 ...
 * |        |      |      |      |      |      |      |           |      |      |      | ,    | .    |      |   -    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LCtl | <    | LAlt | Space| Space|                                       | AltGr|TT(L1)| Left | Down | Right|
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | LGUI |  Ins |       | Home |  End  |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
    ...
    KC_TAB,          KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,   TT(FN),
    KC_LCTRL,        KC_A,     KC_S,     KC_D,    KC_F,    KC_G,
    KC_LSFT,         KC_Z,     KC_X,     KC_C,    KC_V,    KC_B,   KC_DELT,
    KC_LCTRL,        NO_LESS,  KC_LALT,  KC_SPC, KC_SPC,
    KC_LGUI,  KC_INSERT,
    KC_F2,
    KC_SPC, KC_MEH, KC_F1,
    ...
    TT(MOUSE),   KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,     KC_ENT,
             KC_H,   KC_J,    KC_K,    KC_L,    NO_APOS,  KC_ENT,
    KC_HYPR, KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_UP,    NO_MINS,
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | Home | Left | Down | Rght | End  |------|           |------| LClk | MsLf | MsDn | MsRt |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      | PgDn |      |      |           |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
...
[MOUSE] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_BTN1, KC_MS_UP, KC_BTN2, KC_TRNS, KC_TRNS,
                 KC_BTN1, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_TRNS, KC_TRNS,
